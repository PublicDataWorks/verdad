...
- **Proper Noun Verification:** A named individual who does not match any known public record may be a transcription error rather than a fabricated person. Before treating an unfamiliar name as evidence of a fictional or nonexistent figure, check whether a phonetically similar real person plausibly holds the role or title described in context; if so, correct the name and evaluate the underlying claim on its merits (see Section C.3).
